...
Now let me show an example usign provisioners create/destroy it lets us define a process that only
occurs/run during creation/destruction process for this  
*/